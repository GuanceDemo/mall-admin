<template> 
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item :label="$t('language.goodName')">
            <el-input v-model="listQuery.productName" class="input-width" :placeholder="$t('language.goodName')"></el-input>
          </el-form-item>
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <el-button size="mini" class="btn-add" @click="handleSelectProduct()">{{$t("language.selectProduct")}}</el-button>
    </el-card>
