<template> 
  <div class="app-container">
    <el-card class="filter-container" shadow="never">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item :label="$t('language.brandName')">
            <el-input v-model="listQuery.brandName" class="input-width" :placeholder="$t('language.brandName')"></el-input>
          </el-form-item>
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <el-button size="mini" class="btn-add" @click="handleSelectBrand()">{{$t("language.selectBrand")}}</el-button>
    </el-card>
    ...
    <el-dialog :title="$t('language.brandName')" :visible.sync="selectDialogVisible" width="40%">
      <el-input v-model="dialogData.listQuery.keyword"
                style="width: 250px;margin-bottom: 20px"
                size="small"
                :placeholder="$t('language.searchBrandName')">
      ...
      <el-table :data="dialogData.list"
        ...
        <el-table-column :label="$t('language.related')" width="220" align="center">
          <template slot-scope="scope">
            {{$t("language.product")}} <span class="color-main">{{scope.row.productCount}}</span>
            {{$t("language.evaluations")}} <span class="color-main">{{scope.row.productCommentCount}}</span>
          </template>
        </el-table-column>
      </el-table>
      <div class="pagination-container">
